...
NOTE: Get the latest version you can as it is constantly improving (https://github.com/jgm/pandoc).
...
See https://github.com/rockyallen/asciidoctoressays for an Ant script that automates these steps.
